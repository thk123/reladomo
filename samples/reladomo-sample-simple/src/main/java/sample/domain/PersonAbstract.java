...
public abstract class PersonAbstract extends com.gs.fw.common.mithra.superclassimpl.MithraTransactionalObjectImpl
{
	...
	protected int generatePersonId()
	{
		...
		MithraPrimaryKeyGenerator.getInstance().getSimulatedSequencePrimaryKeyGeneratorForNoSourceAttribute("Person", "sample.util.ObjectSequenceObjectFactory",sourceAttribute);
