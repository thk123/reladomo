...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "sample/domain/Person";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "sample.domain.Person";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("sample.domain.Person");
	...
	public static class PersonRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Person, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "sample.domain.PersonFinder";
		}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("sample.domain.Person");
		isFullCache = false;
		isOffHeap = false;
	}
