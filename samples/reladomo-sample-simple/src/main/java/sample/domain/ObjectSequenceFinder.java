...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "sample/domain/ObjectSequence";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "sample.domain.ObjectSequence";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("sample.domain.ObjectSequence");
	...
	public static class ObjectSequenceRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<ObjectSequence, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "sample.domain.ObjectSequenceFinder";
		}
	...
	implements ToOneFinder
	{
		...
		public ObjectSequence findByPrimaryKey(String simulatedSequenceName)
		{
			...
			if (simulatedSequenceName != null)
			{
				...
				_related = _portal.getAsOneFromCache(_bean, _bean, forPrimaryKey, null, null);
				_bean.release();
			}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("sample.domain.ObjectSequence");
		isFullCache = false;
		isOffHeap = false;
	}
